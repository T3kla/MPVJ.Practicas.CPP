...
class ext
{
  public:
    ext()
    {
        std::cout << "    ext constructor" << std::endl;
    }
    ~ext()
    {
    ...
    void size()
    {
        std::cout << "ext  size: " << sizeof(*this) << std::endl;
    };
};
...
class base
{
  public:
    ...
    virtual void print_asd()
    {
        std::cout << "    base asd" << std::endl;
    };
    ...
    void size()
    {
        std::cout << "base size: " << sizeof(*this) << std::endl;
    };
};
...
class dev1 : public base
{
  public:
    dev1()
    {
        std::cout << "    dev1 constructor" << std::endl;
    }
    ~dev1()
    {
        std::cout << "    dev1 deconstructor" << std::endl;
    }
    virtual void print_asd()
    {
        std::cout << "    dev1 asd" << std::endl;
    };
    void size()
    {
        std::cout << "dev1 size: " << sizeof(*this) << std::endl;
    };
};
...
class dev2 : public base
{
  public:
    dev2()
    {
        std::cout << "    dev2 constructor" << std::endl;
    }
    ~dev2()
    {
        std::cout << "    dev2 deconstructor" << std::endl;
    }
    void size()
    {
        std::cout << "dev2 size: " << sizeof(*this) << std::endl;
    };
};
...
class dev3 : public dev1, public dev2
{
  public:
    dev3()
    {
        std::cout << "    dev3 constructor" << std::endl;
    }
    ~dev3()
    {
        std::cout << "    dev3 deconstructor" << std::endl;
    }
    void size()
    {
        std::cout << "dev3 size: " << sizeof(*this) << std::endl;
    };
};
...
void run_practica_14()
{
    ...
    //
    //      Esto es porque la construcion ocurre de base hacia arriba. Al construir
    //      una derivada se construira primero base. En el momento de llamar a la
    //      funcion virtual en el constructor de base, todavia no existen los datos
    //      de la derivada, por lo que se llama a la función virtual al nivel de
    //      base.
    //
    ...
    //
    //      Segun los dioses de stackoverflow, mirar la vtable solo añade alrededor
    ...
    //      procesador asi que a menos que estemos desarrollando para una plataforma
